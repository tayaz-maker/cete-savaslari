...
const isElifRomantic = (state) => ["interest", "partner"].includes(getRelationship(state, "elif").romanceStatus);
...
export const EVENT_DEFINITIONS = [
  ...
  },
  {
    ...
    condition: (state) =>
      getRelationship(state, "elif").romanceStatus === "partner" &&
