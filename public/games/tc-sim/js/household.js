import { addMemory, addNpcMemory, appendCapped, getWeeklyActivityLimit, transact } from "./state.js?v=7";
import { getPerson, getRelationship, applyRelationshipDelta, markMeaningfulContact } from "./social.js?v=7";
import { getHomeById, relocateHome, getMonthlySummary } from "./life.js?v=7";
import { createSecret, transferSecret, isSecretKnownTo } from "./depth2-systems.js?v=7";
