import { createSecret, transferSecret } from "./depth2-systems.js?v=10";
import { addCareerHistory, addNpcMemory } from "./state.js?v=10";
import { applyRelationshipDelta, getPerson, markMeaningfulContact } from "./social.js?v=10";
import {
  createFavor,
