...
export const ADULT_LIFE_EVENTS = [
  ...
  },
  {
    ...
    text: "01:20. Elif'e yarım cümle gittin. Silinmedi. Mavi tik yok daha.",
    condition: (state) =>
      elifBond(state) &&
  ...
  },
  {
    ...
    text: "Elif yürürken: \"Bunu ne sanıyorsun. Ben bir şey bekliyorum, sen beklemıyor olabilirsin.\"",
    condition: (state) => {
      const r = getRelationship(state, "elif");
